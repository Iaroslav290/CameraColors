...
//        guard let imageFrame = imageView.imageFrame,
//              let imageSize = imageView.imageSize,
//              let imageScale = imageView.imageScale else {
//            return .zero
//        }
//
//        let convertedPoint = CGPoint(x: (point.x - imageFrame.origin.x) / imageScale,
//                                     y: (point.y - imageFrame.origin.y) / imageScale)
...
//            frame.size.height = imageViewSize.width / imageAspect
//            frame.origin.x = 0
//            frame.origin.y = (imageViewSize.height - frame.size.height) / 2.0
//        } else {
//            frame.size.height = imageViewSize.height
//            frame.size.width = imageViewSize.height * imageAspect
//            frame.origin.y = 0
//            frame.origin.x = (imageViewSize.width - frame.size.width) / 2.0
//        }
//
//        return frame
//    }
...
//              let imageFrame = self.imageFrame else {
//            return nil
//        }
//
//        return min(imageFrame.width / imageSize.width, imageFrame.height / imageSize.height)
//    }
//}
//
